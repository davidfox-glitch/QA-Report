...
import { ShieldAlert, Zap, BookOpen, Bug, Shield, BarChart3, Upload, ArrowRight, TrendingUp, CloudUpload as Upload2 } from 'lucide-react';
              ...
              <table className="w-full text-left">
                ...
                <tbody className="divide-y divide-white/5">
                  ...
                  <tr className="group hover:bg-white/5 transition-colors">
                    <td className="py-4">
                      <div className="flex items-center gap-3">
                        <Upload2 className="text-tertiary w-5 h-5" />
          ...
          <section className="glass-card rounded-2xl p-6 border-l-4 border-l-error">
            ...
            <div className="space-y-4">
              <div className="p-4 bg-error-container/10 border border-error/20 rounded-xl">
                ...
                <div className="mt-3 flex items-center justify-between">
                  <div className="flex items-center gap-1 text-[10px] text-on-surface-variant">
                    <span className="material-symbols-outlined text-[14px]">person</span> Unassigned
                  </div>
              ...
              <div className="p-4 bg-surface-container-low border border-white/5 rounded-xl">
                ...
                <div className="mt-3 flex items-center justify-between">
                  <div className="flex items-center gap-1 text-[10px] text-on-surface-variant">
                    <span className="material-symbols-outlined text-[14px]">person</span> Sarah K.
                  </div>
